...
chosen between random values as described in [our paper](https://spj.science.org/doi/10.34133/research.1103).
...
| File | Description |
|------|-------------|
| variables.csv | Values for each of the fitting parameters (see Table 1 in the preprint for a description of the physical meaning of each parameter) |
...
the resultant drain current [unit: uA/um]. 

We use the first 25,000 devices to
...
running the script [process_data.py](./../demo/process_data.py).
