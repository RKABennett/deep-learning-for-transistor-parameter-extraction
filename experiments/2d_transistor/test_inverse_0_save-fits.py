...
model_inverse = load_model(
    model_name_inverse, custom_objects={"surrogate_loss": NNv.dummy_fn}
)

model_forward_fully_trained = load_model(
    "NN_forward_fully_trained.keras", custom_objects={"CombinedMSELoss": NNv.dummy_fn}
)

_, _, errors = evaluation.test_model_inverse_current(
    X_test,
    Y_test,
